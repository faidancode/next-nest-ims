  ...
  return (
    <div className="flex items-center gap-1">
      ...
      {(showApproval || showDelete) && (
        <div className="w-[2px] h-4 bg-slate-100 mx-1 rotate-15" />
      )}
      ...
      {showApproval && onApprove && (
        <AlertDialog>
          <AlertDialogTrigger asChild>
            ...
            >
              <CheckCircle size={12} className="mr-1.5 stroke-[3px]" /> Approve_Unit
            </Button>
          </AlertDialogTrigger>
            ...
            <div className="p-8">
              <AlertDialogHeader>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <AlertDialogTitle className="text-lg font-black uppercase italic tracking-tighter">Authorize_Payload</AlertDialogTitle>
                </div>
                <AlertDialogDescription className="text-slate-500 text-[11px] font-mono leading-relaxed uppercase">
                  Confirming authorization for: <span className="text-slate-900 font-black">"{entityName}"</span>.
                  Status update will be broadcasted to the system immediately.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter className="mt-8 gap-2">
                <AlertDialogCancel className="rounded-none border-2 border-slate-200 font-black text-[10px] uppercase tracking-widest h-10 px-6">Abort</AlertDialogCancel>
                <AlertDialogAction
            ...
            <div className="p-8">
              <AlertDialogHeader>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <AlertDialogTitle className="text-lg font-black uppercase italic tracking-tighter">Terminate_Record</AlertDialogTitle>
                </div>
                <AlertDialogDescription className="text-slate-500 text-[11px] font-mono leading-relaxed uppercase">
                  Warning: You are purging <span className="text-slate-900 font-black">"{entityName}"</span>.
                  Data integrity check: This action is non-reversible.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter className="mt-8 gap-2">
                <AlertDialogCancel className="rounded-none border-2 border-slate-200 font-black text-[10px] uppercase tracking-widest h-10 px-6">Cancel</AlertDialogCancel>
                <AlertDialogAction
                  onClick={() => onDelete(id)}
